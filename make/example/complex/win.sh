...
name="globuf_example_complex_win"
cmd="./\$name"
...
libs+=("\$folder_library/globuf_pe_software.a")
	...
	wgl)
ninja_file=example_complex_win_wgl.ninja
...
ldlibs+=("-lopengl32")
	...
	vulkan)
ninja_file=example_complex_win_vulkan.ninja
...
echo "    command = \$cc -Ires/cursor -c res/cursor/cursorpix_pe.S -o \$out"; \
echo "    description = \$cc \$out"; \
echo ""; \
} >> "$output/$ninja_file"
